; NSIS installer para CanchaYa Print Native Messaging Agent.
...
Name "${APP_NAME}"
OutFile "/Users/andress/juanma/canchaya-print-extension/installers/dist\CanchaYaPrintAgent-0.10.4.exe"
